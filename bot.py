...
#from reportlab.lib.randomtext import sentences
...
COMMENTS_ABOUT_SELF = [
    ...
    "My Klout score is {}".format(rand.randint(100, 500)),
]
# end
...
#        print(word)
        if word.lower() in GREETING_KEYWORDS:
            print(rand.choice(GREETING_RESPONSES))
...
SELF_VERBS_WITH_ADJECTIVE = [
    ...
    "I consider myself to be a {adjective} entrepreneur",
]
...
def construct_response(pronoun, noun, verb):
    ...
    resp.append(rand.choice(("tho", "bro", "lol", "bruh", "smh", "")))

    return " ".join(resp)

#print(check_for_greeting("hello this is kunal"))
